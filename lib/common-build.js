...
const commonBuild = ( options )=>{
    ...
    let {targetBuildType, frontendBuildCommand = 'npm run build', backendProjectDir, distDirPath, frontendProjectDir, ftpOptions} = options;
    ...
    if (buildTypes.includes(validTypes.frontend)) {
        ...
        execSync(frontendBuildCommand, { cwd: frontendProjectDir, stdio: 'inherit' });
